						...
						<div class="row">
							<div class="form-inline">
								<div class="form-group">
									<label class="control-label wk-filed-label">课程名称:
									</label>
									<div class="input-group">
										<input required="required" name="cName" type="text"
								...
								<div class="form-group">
									<label class="control-label wk-filed-label">课程编号:
									</label>
									<div class="input-group">
										<input required="required" name="tnumber" type="text"
											class="form-control wk-normal-input"
											placeholder="请输入课程编号" />
									</div>
								</div>
							...
							<div class="form-inline">
								<div class="form-group">
									<label class="control-label wk-filed-label">课程介绍:
									</label>
									<div class="input-group">
										<input required="required" name="info" type="text"
