    ...
    <div class="row">
        <div class="col-lg-12">
            <div class="panel panel-default wk-panel ">
                ...
                <form action="<%=basePath%>/createQuestion" method="POST">
                <div class="panel-body">
                    <div class="row">
                    
                      <div class="form-inline">  
                            <div class="form-group">
                                <label class="control-label wk-filed-label">题目: </label>
                        ...
                        <div class="form-inline">  
                            <div class="form-group">
                                <label class="control-label wk-filed-label">选项A: </label>
                                 <div class="input-group">
                        ...
                        <div class="form-inline">  
                            <div class="form-group">
                                <label class="control-label wk-filed-label">选项B: </label>
                                 <div class="input-group">
                        ...
                        <div class="form-inline">  
                            <div class="form-group">
                                <label class="control-label wk-filed-label">选项C: </label>
                                 <div class="input-group">
                        ...
                        <div class="form-inline">  
                            <div class="form-group">
                                <label class="control-label wk-filed-label">选项D: </label>
                                 <div class="input-group">
						...
						<div class="form-inline">  
                            <div class="form-group">
                                <label class="control-label wk-filed-label">分值: </label>
                                 <div class="input-group">
