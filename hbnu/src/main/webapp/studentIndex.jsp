    ...
    <div class="row">
        <div class="col-lg-12">
            <ul class="nav nav-tabs wk-nav-menu" id="wk-nav-menu">
                <li role="presentation"><a id="leftNav">[学生:欢迎登陆${user.name }]</a></li>
                ...
                <li role="presentation"><a href="/getCourse" id="wk-menu-panel-item-searchCourseInfo" class="wk-main-menu-item">查看课程</a></li>
...
<%--                                    <button type="button" class="list-group-item" id="wk-menu-panel-item-searchStudentTaskInfo"> >&nbsp;&nbsp;查询已完成考试</button>--%>
         ...
         <div  id="rightTable" class="col-lg-10" style="padding:0px;">
            <iframe id="mainFrame" src="<%=basePath%>/searchNoticeInfoA.jsp" width="100%" frameborder="0" onload="changeFrameHeight()">
            </iframe>
         </div>
    </div>
